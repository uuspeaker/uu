...
Page({
  ...
  doQuerySpecialTask: function (queryUserType) {
    ...
    //util.showBusy('请求中...')
    var queryData = { 'queryPageType': queryPageType, 'firstDataTime': firstDataTime, 'lastDataTime': lastDataTime, queryUserType: queryUserType, audioType:3 }
  ...
  toAudioDetail: function (e) {
    innerAudioContext.stop();
    wx.navigateTo({
      url: '../../feedback/feedbackDetail/feedbackDetail?audioId=' + e.currentTarget.dataset.audio_id,
    })
  },
  ...
  onReady: function () {
    wx.setNavigationBarTitle({ title: '听建议' });
  },
